 ...
 * @group Event
 * @group Listener
 * @group AssetStoreStoragePublishListenerTest
 * Add your own group annotations below this line
 */
class AssetStoreStoragePublishListenerTest extends Unit
{
    /**
    ...
    public function setUp(): void
    {
        ...
        $this->assetStoreStoragePublishListener = (new AssetStoreStoragePublishListener())
    ...
    public function testHandleWithCorrectDataSuccessfully(): void
    {
        ...
        // Act
        $this->assetStoreStoragePublishListener->handle(
            $eventTransfer,
