...
namespace Spryker\Client\AssetStorage\Dependency\Service;

use Spryker\Service\Synchronization\Dependency\Plugin\SynchronizationKeyGeneratorPluginInterface;

class AssetStorageToSynchronizationServiceBridge implements AssetStorageToSynchronizationServiceInterface
{
    /**
